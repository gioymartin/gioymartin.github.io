$(document).ready(function () {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      // Event title
      title: " Casamiento Giovanna y Martín ",

      // Event start date
      //   start: new Date("Sept 14, 2019 10:00"),
      start: new Date("Feb 03, 2024 21:00"),
      ...
      end: new Date("Feb 03, 2024 21:00"),

      // Event Address
      address: "Iglesia San José",

      // Event Description
      description: "No podemos esperar para celebrar junto a vos!.",
    },
  });
  ...
  $("#rsvp-form").on("submit", function (e) {
    ...
    $("#alert-wrapper").html(
      alert_markup(
        "info",
        "<strong>Sólo un momento!</strong> Estamos verificando tus detalles."
      )
    );
